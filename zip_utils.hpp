...
//Modification of https://gist.github.com/clalancette/bb5069a09c609e2d33c9858fcc6e170e
...
bool zip_utils::is_dir(const std::string& dir)
{
  struct stat st;
  ::stat(dir.c_str(), &st);
...
void zip_utils::walk_directory(const std::string& startdir, const std::string& inputdir, zip_t *zipper)
{
...
void zip_utils::zip_directory(const std::string& inputdir, const std::string& output_filename)
{
  int errorp;
